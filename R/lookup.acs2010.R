...
#' @title Sequence_Number_and_Table_Number_Lookup.txt for 2006-2010 ACS dataset
...
#' @usage data('lookup.acs2010')
#' @source For the 2006-2010 dataset, \url{ftp://ftp.census.gov/acs2010_5yr/summaryfile/Sequence_Number_and_Table_Number_Lookup.txt}
#'   obtained July 2015.
#' @keywords datasets
...
#' @examples
#'  \dontrun{
#'  data(lookup.acs2010, package='ACSdownload')
#'  # or
#'  lookup.acs <- ACSdownload::get.lookup.acs(2010)
