#' @title Get field names etc for ACS tables - somewhat obsolete/not updated
#' @description
...
#' @seealso [tidycensus package](https://walker-data.com/tidycensus/index.html)  [get_acs_old()], [get.table.info()], and [get.field.info()]
#'
#' @keywords internal
#'
