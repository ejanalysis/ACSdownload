...
#'   If vars is 'ask', the function just looks in `data.folder` for a file called "variables needed.csv" that, if used,
...
#' <https://www.census.gov/acs/www/data_documentation/summary_file/> \cr \cr
#'
#'  LARGER THAN NECESSARY: \cr\cr
#'
#'	*** all states and all tables in one huge tar.gz file (plus a zip of all geography codes)  \cr
#'	<ftp://ftp.census.gov/acs2011_5yr/summaryfile//2007-2011_ACSSF_All_In_2_Giant_Files(Experienced-Users-Only)> \cr
#'	<ftp://ftp.census.gov/acs2011_5yr/summaryfile//2007-2011_ACSSF_All_In_2_Giant_Files(Experienced-Users-Only)/2011_ACS_Geography_Files.zip> \cr
...
#'	<http://www.census.gov/geo/maps-data/data/tiger-data.html> \cr
