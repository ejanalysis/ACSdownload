#' @name geoformat2016
#' @docType data
#' @title geographic information for 2012-2016 ACS dataset
...
#' @source For the 2012-2016 dataset, \url{http://www2.census.gov/programs-surveys/acs/summary_file/2016}
#'   more specifically on page 12 of 22 in \url{https://www2.census.gov/programs-surveys/acs/summary_file/2016/documentation/tech_docs/2016_SummaryFile_Tech_Doc.pdf}
