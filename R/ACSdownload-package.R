...
#' @seealso \pkg{\link[tidycensus]{tidycensus}} to use a key to request ACS or Decennial Census data, but it is slow if you want all blockgroups in a state or nationwide.
