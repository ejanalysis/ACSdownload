...
#' @source For the 2010-2014 dataset, \url{http://www2.census.gov/programs-surveys/acs/summary_file/2014/documentation/user_tools/ACS_5yr_Seq_Table_Number_Lookup.txt}
...
#' @examples
#'  \dontrun{
#'  data(lookup.acs2014, package='ACSdownload')
#'  # or
#'  lookup.acs <- ACSdownload::get.lookup.acs(2014)
