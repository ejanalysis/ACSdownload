#' @name lookup.acs2015
#' @docType data
#' @title ACS_5yr_Seq_Table_Number_Lookup.txt for 2011-2015 ACS dataset
...
#' @usage data('lookup.acs2015')
#' @source For the 2011-2015 dataset, \url{http://www2.census.gov/programs-surveys/acs/summary_file/2015/documentation/user_tools/ACS_5yr_Seq_Table_Number_Lookup.txt}
#'   obtained July 20, 2018.
#' @keywords datasets
#' @format A data.frame with these fields: \cr
#'    'data.frame':	25024 obs. of  8 variables:
#'   \itemize{
