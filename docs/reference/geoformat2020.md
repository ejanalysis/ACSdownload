...
December of the year X+1, so 2016-2020 was available by Dec 2021.
...
that is the full US geo file, not what I call the geoformat file (which
is tiny)

2018 and 2019 lack the normal geo file documentation they used to have
also, read.geo() used read.fwf() at least for older years. 2018 or 2019
might have csv not just txt format now?
