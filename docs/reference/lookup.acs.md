...
This data set provides information about variables in tables from the
latest American Community Survey (ACS) 5-year summary file.
...
The data and documentation for the 5 years ending in year X is typically
available by December of the year X+1.
